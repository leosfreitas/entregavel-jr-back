...
class AppraisersModel(Document):
    sensivity_fields = [
    ...
    def get_normal_fields():
        return [i for i in AppraisersModel.__dict__.keys() if i[:1] != '_' and i != "sensivity_fields" and i not in AppraisersModel.sensivity_fields]
