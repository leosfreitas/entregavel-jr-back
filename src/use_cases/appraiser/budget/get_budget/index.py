...
from use_cases.appraiser.budget.get_budget.get_budget_use_case import GetBudgetsUseCase

router = APIRouter()

get_budgets_use_case = GetBudgetsUseCase(BudgetRepository())

@router.get("/user/get-budgets", dependencies=[Depends(validade_appraiser_auth_token)])
